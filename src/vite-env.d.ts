...
declare global {
  interface Window {
    api: {
      ...
      getFactoryCustomModelsWithId: () => Promise<import("./types").FactoryCustomModelWithId[]>;
      saveFactoryCustomModels: (models: import("./types").FactoryCustomModelWithId[]) => Promise<void>;
